    ...
    <div className="space-y-6 w-100%">
      <form onSubmit={handleSubmit} className="space-y-4">
        <textarea
          ...
          className="w-full min-h-[150px] resize-none rounded-md border border-sky-300 p-3 text-sm focus:border-teal-500 focus:ring-2 focus:ring-sky-500 focus:ring-opacity-50 outline-none"
          value={symptoms}
      ...
      {prediction && (
        <div className="border border-purple-200 rounded-lg shadow-md overflow-hidden">
          <div className="bg-gradient-card-2 border-b border-purple-100 px-6 py-4">
            <h3 className="text-lg font-medium text-purple-700">Analysis Results</h3>
