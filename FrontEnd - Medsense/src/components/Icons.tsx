...
// This file contains all the icon components used in the application
// Using a single file for icons helps with consistency and reduces imports

export function Activity(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function History(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function Pill(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
// Add these to your Icons.tsx component
export const Plus = ({ className = "h-6 w-6" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    viewBox="0 0 24 24"
...
export const ArrowLeft = ({ className = "h-6 w-6" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    viewBox="0 0 24 24"
